...
#
# Script generated by Vivado on Tue Nov 26 21:06:08 -0500 2024
...
#
# Usage        : xfft_1.sh
#                xfft_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xfft_1.sh [-reset_run]
#                xfft_1.sh [-reset_log]
#                xfft_1.sh [-help]
#
...
#                script (type 'xfft_1.sh -help' for more information).
#
...
# script info
echo -e "xfft_1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xfft_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xfft_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xfft_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xfft_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: xfft_1.sh [-step]\n\
Usage: xfft_1.sh [-lib_map_path]\n\
Usage: xfft_1.sh [-reset_run]\n\
Usage: xfft_1.sh [-reset_log]\n\
Usage: xfft_1.sh [-keep_index]\n\
