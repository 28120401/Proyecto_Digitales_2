...
HD_PWD='C:/Users/adria/vivadoAndrea/proyectoDigitales2/proyectoDigitales2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fft_xadc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_fft_xadc.tcl
