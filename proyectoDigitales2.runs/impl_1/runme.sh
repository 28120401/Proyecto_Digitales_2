...
HD_PWD='C:/Users/adria/vivadoAndrea/proyectoDigitales2/proyectoDigitales2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fft_xadc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_fft_xadc.tcl -notrace
